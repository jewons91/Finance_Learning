...
class PPOTrainer:
    ...
    def plot_results(self, episode, total_reward, filename):
        ...
        for idx in buy_indices:
            plt.plot(idx, self.env.price_history['000660'][idx], 'o', color='black' markersize=2)  # 빨간 점 찍기
...
# 트레이너 생성
trainer = PPOTrainer(env, policy, memory, optimizer, gamma=0.4, epsilon=0.8, epochs=30)
