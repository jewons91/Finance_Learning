...
for ticker in tickers:
    ...
    feature_cols = ['Close', 'Low', 'MA10', 'MA20', 'RSI', 'Upper_Band', 'Lower_Band', 'Power']
    # power_cols = ['Power']
...
optimizer = optim.AdamW(policy.parameters(), lr=1e-5)  # 학습률 감소
memory = Memory()

# 트레이너 생성
trainer = PPOTrainer(env, policy, memory, optimizer, gamma=0.5, epsilon=0.5, epochs=15)
