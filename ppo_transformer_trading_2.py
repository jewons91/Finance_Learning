    ...
    def _next_observation(self):
        ...
        for ticker, df in self.dfs.items():
            ...
            if idx < self.seq_length:
                # 충분한 시퀀스가 없으면 제로 패딩
                seq = df.loc[:idx, ['Close', 'MA10', 'MA20', 'RSI', 'Power', 'Upper_Band', 'Lower_Band']].values
                ...
                # 시퀀스 슬라이싱
                seq = df.loc[idx - self.seq_length:idx - 1, ['Close', 'MA10', 'MA20', 'RSI', 'Power', 'Upper_Band', 'Lower_Band']].values
